  ...
  return (
    <div className="dashboard-content">
      <div className="content-header">
        <div>
          <h2 className="content-title">Billing & Invoices</h2>
          <p className="content-description">Manage billing and invoice generation</p>
        </div>
        <button 
      ...
      <div className="view-toggle">
        <button 
          className={`view-btn ${activeView === 'my-bills' ? 'active' : ''}`}
          onClick={() => setActiveView('my-bills')}
        >
          My Bills (Internal)
        </button>
        <button 
          className={`view-btn ${activeView === 'customer-bills' ? 'active' : ''}`}
          onClick={() => setActiveView('customer-bills')}
        >
          Customer Bills (External)
        </button>
      </div>
        ...
        <table className="data-table">
          <thead>
            <tr>
              ...
              <th>Customer</th>
              <th>Amount</th>
              {activeView === 'my-bills' && <th>Cost</th>}
              {activeView === 'my-bills' && <th>Margin</th>}
              <th>Status</th>
              <th>Invoice Date</th>
              <th>Due Date</th>
              {activeView === 'my-bills' && <th>Paid Amount</th>}
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
